...
VIDEO_PATH = 'C:/Users/xiayu/Desktop/counting_test.avi'
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if videoWriter is None:
            ...
            path = "templates/recording/" + strData + "_" + strTime + '.mp4'
            videoWriter = cv2.VideoWriter(path, fourcc, fps, (output_image_frame.shape[1], output_image_frame.shape[0]))
            print(path)
